        ...
        <div class="elo-calculator">
          ...
          <div v-if="eloResult" class="results-section">
            ...
            <div class="result-item">
              ...
              <span class="value performance">{{ formatEloRating(eloResult) }}</span>
            </div>
            ...
            <div class="result-item">
              <span class="label">{{ $t('eloCalculator.confidenceInterval') }}:</span>
              <span class="value">{{ formatConfidenceInterval(eloResult) }}</span>
            </div>
            ...
            <div class="result-item">
              <span class="label">{{ $t('eloCalculator.standardError') }}:</span>
              <span class="value">{{ eloResult.standardError.toFixed(4) }}</span>
            </div>
          </div>
...
watch(() => props.initialWins, (newValue) => {
  wins.value = newValue
})

watch(() => props.initialLosses, (newValue) => {
  losses.value = newValue
})

watch(() => props.initialDraws, (newValue) => {
